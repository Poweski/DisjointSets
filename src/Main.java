...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(forestSet.findSet(allForestElements.get(4)));
        System.out.println();

        System.out.println(forestSet.findSet(allForestElements.get(8)));
        System.out.println();
        ...
        System.out.println(listSet.findSet(allListElements.get(4)));
        System.out.println();

        System.out.println(listSet.findSet(allListElements.get(8)));
